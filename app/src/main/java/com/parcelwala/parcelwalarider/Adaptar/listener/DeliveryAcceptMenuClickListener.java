...
public class DeliveryAcceptMenuClickListener implements View.OnClickListener {
    int spinnerPosition = 0;
    AcceptDeliveryAdaptar percelListAdapter;
    DeliveryAlertDialog myAlertDialog;
    AcceptDeliveryAdaptar.OnItemClickListener listenerd;
    AcceptDeliveryAdaptar.Viewholders viewHolders;
    ...
    public DeliveryAcceptMenuClickListener(AcceptDeliveryAdaptar percelListAdapter, AcceptDeliveryAdaptar.OnItemClickListener listenerd,
                                           AcceptDeliveryAdaptar.Viewholders viewHolders, DeliveryParcel percel) {
